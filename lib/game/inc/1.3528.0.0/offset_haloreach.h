...
#define OFFSET_HALOREACH_PV_HUD_DRAWING_PLAYER 0xD1F71C // int user whose HUD is being drawn
#define OFFSET_HALOREACH_PV_HUD_CANVAS 0xD1F6F0 // float width, height of that user's HUD virtual canvas
