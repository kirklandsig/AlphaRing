// Written by XiaoDanny (Daniel Coyle) for megabitt01/AlphaRing #17 and #20; ported with credit (MIT).
...
namespace {
    ...
    // Rebuilt from the overlay, read by Reach's render hook every frame. (AlphaRing kirklandsig
    // fork: guarded after a Codex review flagged the unsynchronized rebuild.)
    std::mutex g_writesMutex;
